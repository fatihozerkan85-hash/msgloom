    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-green-500 to-green-700 items-center justify-center p-12">
        <div className="text-white max-w-md">
          ...
          <p className="text-green-100 text-lg mb-8">Ücretsiz hesap oluşturun ve hemen mesaj göndermeye başlayın.</p>
          <div className="bg-white/10 rounded-2xl p-6 backdrop-blur-sm">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">💬</div>
              <div>
                <p className="font-medium">100 mesaj/ay ücretsiz</p>
                <p className="text-green-200 text-sm">Kredi kartı gerekmez</p>
              </div>
            </div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">⚡</div>
              <div>
                ...
                <p className="text-green-200 text-sm">Hemen kullanmaya başlayın</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-green-200 text-sm">KVKK uyumlu veri saklama</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-8">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" value={form.name} onChange={update('name')}
                  className="w-full border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-green-500 focus:border-transparent focus:outline-none transition" required />
              </div>
              <div>
            ...
            <div>
              ...
              <input type="password" value={form.password} onChange={update('password')}
                className="w-full border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-green-500 focus:border-transparent focus:outline-none transition" placeholder="En az 6 karakter" required minLength={6} />
            </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            Zaten hesabınız var mı? <Link href="/login" className="text-green-600 font-medium hover:underline">Giriş yapın</Link>
          </p>
        </div>
      </div>
    </div>
