      ...
      <section id="setup" className="py-20 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <FadeIn delay={0.5}>
              <motion.div
                animate={{ boxShadow: ['0 0 0px rgba(0,0,0,0)', '0 4px 15px rgba(0,0,0,0.08)', '0 0 0px rgba(0,0,0,0)'] }}
                transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}
                className="bg-gray-50 rounded-xl px-5 py-3 inline-flex items-center gap-2"
              >
