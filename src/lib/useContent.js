...
const fallback = {
  ...
  footer: { desc: 'WhatsApp & Telegram mesajlaşma yönetiminde güvenilir çözüm ortağınız.', col1_title: 'KURUMSAL', col1_link1: 'Hakkımızda', col1_link2: 'Blog', col1_link3: 'Özellikler', col1_link4: 'S.S.S.', col2_title: 'YASAL METİNLER', col2_link1: 'Mesafeli Satış Sözleşmesi', col2_link2: 'İptal ve İade Koşulları', col2_link3: 'KVKK Aydınlatma Metni', col2_link4: 'Gizlilik Politikası', col2_link5: 'Çerez Politikası', col2_link6: 'Bilgi Güvenliği Politikası', col3_title: 'BİZE ULAŞIN', col3_line1: 'E-posta: destek@msgloom.com.tr', col3_line2: 'Adres: İstanbul/Türkiye', col3_line3: 'Tel: +90 850 000 00 00', col3_payments: 'Visa / Mastercard / iyzico', copyright: '© 2026 MsgLoom. Tüm hakları saklıdır.' },
};
